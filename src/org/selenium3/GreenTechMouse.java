...
public static void main(String[] args) throws InterruptedException {
	...
	WebElement btnsf = d.findElement(By.xpath("//span[text()='Selenium Training']"));
	btnsf.click();
	WebElement btn2 = d.findElement(By.xpath("(//p[contains(text(),'Testers')])[1]"));
