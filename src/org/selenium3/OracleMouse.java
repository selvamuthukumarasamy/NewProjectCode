...
public static void main(String[] args) throws InterruptedException {
	...
	WebElement btnsf = d.findElement(By.xpath("//span[text()='Oracle Training ']"));
	ac.moveToElement(btnsf).perform();
	WebElement btn3 = d.findElement(By.xpath("//span[text()='Oracle SQL Training']"));
	ac.moveToElement(btn3).perform();
	WebElement btn2 = d.findElement(By.xpath("//li[contains(text(),'Basic ')]"));
